...
$(function () {
	...
	if(isJiFenPage() == 1) {
		...
		$('.ShopCart').hide();
		$('.mobile-joinCar').hide();
		console.log($(".join-car").html(),12321321321321);
		$(".join-car").remove();
	}
...
// 初始化标签页模块
function initModuleTabContainer(moduleID, showStyle, layout){
...
function replaceNewShopUrl(){
    ...
    $('a').each(function(){
        ...
        if(/^\/ProductOrder/i.test(href)){  //购物车
            $(this).attr('href', '/home/shop/#/shopcart')
        }
...
﻿/*! layer-v3.0.3 Web弹层组件 MIT License  http://layer.layui.com/  By 贤心 */
 ...
 addScript('/r376.mdemo.yz168.cc/scripts/bootstrap/bootbox.min.js',null,true);
 addScript('/r376.mdemo.yz168.cc/framework/ref/scripts/jquery.ajaxfileupload.js',null,true);
 addScript('/r376.mdemo.yz168.cc/scripts/cityselect/Region.js',null,true);